...
func TestShouldSilenceLog(t *testing.T) {
	tests := []struct {
		...
		{"GET", "/", true},
		{"GET", "/_/admin/css/admin.css", true},
		{"GET", "/_/admin/js/admin.js", true},
		{"GET", "/_/uploads/css/uploads.css", true},
		{"GET", "/_/uploads/js/uploads.js", true},
		{"GET", "/_/login/css/login.css", true},
		{"GET", "/_/login/js/login.js", true},
